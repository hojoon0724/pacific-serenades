...
const destinationFolder = "./concertData/concerts";
const destinationFile = "./concertData/allConcertsData.json";

const sampleConcertObj = {
  title: "concert title",
  dates: [
    { date: "concert date and time", location: "venueId" },
    { date: "concert date and time", location: "venueId" },
    { date: "concert date and time", location: "venueId" },
  ],
  program: [
    { composer: "composerId", workName: "work name str", year: "1999", instrumentation: "instrumentation info" },
    { composer: "composerId", workName: "work name str", year: "1999", instrumentation: "instrumentation info" },
    { composer: "composerId", workName: "work name str", year: "1999", instrumentation: "instrumentation info" },
  ],
  musicians: ["musicianOneId", "musicianTwoId", "musicianThreeId"],
};
