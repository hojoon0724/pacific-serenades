...
const sourceFolder = "./htmlPages/worksPages";

const destinationFolder = "./extractedJSON/works";
const destinationFile = "./extractedJSON/worksData.json";
...
async function processFile(filePath) {
  try {
    ...
    let work = {
      [fileNameCamel]: {
        id: fileNameCamel,
        workName: workNameData[0] ? workNameData[0].replace("&amp;", "&") : "",
        workYear: workYearData[0] ? workYearData[0].replace("&amp;", "&") : "",
        workComposer: workComposerId,
        purchaseLink: purchaseLinkData[0] ? purchaseLinkData[0].replace("&amp;", "&") : "",
        video: videoData,
        audio: audioData,
        description: descriptionInHtml[0] ? descriptionInHtml[0].replace("&amp;", "&") : "",
      },
    };
