  ...
  theme: {
    extend: {
      ...
      fontSize: {
        ...
        subtitle1: ['1rem', { lineHeight: '1.75', letterSpacing: '0.15px' }],
        ...
        button: ['0.875rem', { lineHeight: '1.75', letterSpacing: '1.25px', textTransform: 'uppercase' }],
        caption: ['0.75rem', { lineHeight: '1.66', letterSpacing: '0.4px' }],
        overline: ['0.625rem', { lineHeight: '1.66', letterSpacing: '1.5px', textTransform: 'uppercase' }],
      },
      fontWeight: {
        light: 300,
        normal: 400,
