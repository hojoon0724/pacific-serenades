export default function StatementJeff({}) {
  return (
    <div className="welcome-paragraph-container py-8">
      <div className="welcome-paragraph-text max-w-prose">
        ...
        <p>
          ...
          MANY Pacific Serenades concerts, as well as writing a commission for the organization in 2009. I’ve always
          admired Mark’s unwavering dedication to the promotion of new music through his many years with Pacific
          Serenades. His mission, along with that of the organization, to present new music as an integral part of our
