...
export default function Footer({}) {
  return (
    <footer className="text-center flex flex-col gap-2 z-50">
      ...
      <div className="footer-line-3 bg-black w-full p-1" style={{ fontSize: "0.6rem", fontFamily: "Roboto Mono, monospace", fontWeight: "400",
  letterSpacing: "0.1ch"}}>
