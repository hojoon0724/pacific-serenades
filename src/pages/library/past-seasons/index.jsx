...
export default function PastSeasons() {
  return (
    <div className="all-seasons-container grid grid-cols-1 gap-8 m-8">
        ...
        return (
          <div className="season" key={season.slice(0, 4)}>
            <div className="season-container bg-blue-50 p-4 rounded-xl">
              <div className="season-name text-xl font-bold bg-blue-700 rounded-lg px-4 py-2 text-blue-50">{season}</div>
